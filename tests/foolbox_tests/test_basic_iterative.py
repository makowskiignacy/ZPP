...
class TestBasicIterative:
    ...
    def test_bi_1_a(self):
        test_logger.info("L1 Basic Iterative attack with Adam optimizer test running")
    ...
    def test_bi_2_a(self):
        test_logger.info("L2 Basic Iterative attack with Adam optimizer test running")
    ...
    def test_bi_inf_a(self):
        test_logger.info("L infinity Basic Iterative attack with Adam optimizer test running")
