...
class TestProjectedGradientDescent:
    ...
    def test_pgd_1(self):
        print("L1 Projected Gradient Descent attack test running")
        attack_pgd1 = L1ProjectedGradientDescent(self.parameters)
        result1 = run_attack(attack_pgd1, self.model, self.data)
        return result1

    def test_pgd_2(self):
        print("L2 Projected Gradient Descent attack test running")
    ...
    def test_pgd_inf(self):
        print("L infinity Projected Gradient Descent attack test running")
    ...
    def test_pgd_1_a(self):
        print("L1 Projected Gradient Descent attack with Adam optimizer test running")
    ...
    def test_pgd_2_a(self):
        print("L2 Projected Gradient Descent attack with Adam optimizer test running")
    ...
    def test_pgd_inf_a(self):
        print("L infinity Projected Gradient Descent attack with Adam optimizer test running")
