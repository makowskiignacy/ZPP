...
class TestProjectedGradientDescent:
    ...
    def test_pgd_1(self):
        logger.info("L1 Projected Gradient Descent attack test running")
        attack_pgd1 = L1ProjectedGradientDescent(self.parameters)
        result1 = run_attack(attack_pgd1, self.model, self.data)
        return result1

    def test_pgd_2(self):
        logger.info("L2 Projected Gradient Descent attack test running")
    ...
    def test_pgd_inf(self):
        logger.info("L infinity Projected Gradient Descent attack test running")
    ...
    def test_pgd_1_a(self):
        logger.info("L1 Projected Gradient Descent attack with Adam optimizer test running")
    ...
    def test_pgd_2_a(self):
        logger.info("L2 Projected Gradient Descent attack with Adam optimizer test running")
    ...
    def test_pgd_inf_a(self):
        logger.info("L infinity Projected Gradient Descent attack with Adam optimizer test running")
