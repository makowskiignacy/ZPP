...
class TestAdditiveNoise:
    ...
    def test_an_l2_g(self):
        logger.info("L2 Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_u(self):
        logger.info("L2 Additive Uniform Noise attack test running")
    ...
    def test_an_l2_cag(self):
        logger.info("L2 Clipping Aware Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_cau(self):
        logger.info("L2 Clipping Aware Additive Uniform Noise attack test running")
    ...
    def test_an_l2_carg(self):
        logger.info("L2 Clipping Aware Repeated Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_caru(self):
        logger.info("L2 Clipping Aware Repeated Additive Uniform Noise attack test running")
    ...
    def test_an_l2_rg(self):
        logger.info("L2 Repeated Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_ru(self):
        logger.info("L2 Repeated Additive Uniform Noise attack test running")
    ...
    def test_an_inf_u(self):
        logger.info("Linf Additive Uniform Noise attack test running")
    ...
    def test_an_inf_ru(self):
        logger.info("Linf Repeated Additive Uniform Noise attack test running")
