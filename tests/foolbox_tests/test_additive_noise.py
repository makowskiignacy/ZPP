...
class TestAdditiveNoise:
    ...
    def test_an_l2_g(self):
        test_logger.info("L2 Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_u(self):
        test_logger.info("L2 Additive Uniform Noise attack test running")
    ...
    def test_an_l2_cag(self):
        test_logger.info("L2 Clipping Aware Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_cau(self):
        test_logger.info("L2 Clipping Aware Additive Uniform Noise attack test running")
    ...
    def test_an_l2_carg(self):
        test_logger.info("L2 Clipping Aware Repeated Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_caru(self):
        test_logger.info("L2 Clipping Aware Repeated Additive Uniform Noise attack test running")
    ...
    def test_an_l2_rg(self):
        test_logger.info("L2 Repeated Additive Gaussian Noise attack test running")
    ...
    def test_an_l2_ru(self):
        test_logger.info("L2 Repeated Additive Uniform Noise attack test running")
    ...
    def test_an_inf_u(self):
        test_logger.info("Linf Additive Uniform Noise attack test running")
    ...
    def test_an_inf_ru(self):
        test_logger.info("Linf Repeated Additive Uniform Noise attack test running")
